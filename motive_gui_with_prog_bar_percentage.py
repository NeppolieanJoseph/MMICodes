...
def main():
	...
	tk.geometry('460x300+250+200')
	tk.configure(bg='grey')
	lbl = Label(tk, text="Progress...", bg='grey', fg='purple')
	lbl.place(x=20,y=40,width=300,height=20)
	...
	def bar():
		...
		try:
			...
			progress['value']=20
			tk.update_idletasks()
			lbl = Label(tk, text="20%", bg='grey', fg='purple')
			lbl.place(x=420,y=211,width=30,height=20)
			time.sleep(1)
		except (IOError,pywintypes.error,WindowsError) as e:
			print '\n'+str(e)
			copy_token_file()
		...
		try:
			...
			progress['value']=30
			tk.update_idletasks()
			lbl = Label(tk, text="40%", bg='grey', fg='purple')
			lbl.place(x=420,y=211,width=30,height=20)
			time.sleep(1)
		except (IOError,pywintypes.error,WindowsError) as e:
		...
		try:
			...
			progress['value']=40
			tk.update_idletasks()
			lbl = Label(tk, text="60%", bg='grey', fg='purple')
			lbl.place(x=420,y=211,width=30,height=20)
			time.sleep(1)
		except (IOError,pywintypes.error,WindowsError) as e:
		...
		try:
			...
			progress['value']=50
			tk.update_idletasks()
			lbl = Label(tk, text="80%", bg='grey', fg='purple')
			lbl.place(x=420,y=211,width=30,height=20)
			time.sleep(1)
		except (IOError,pywintypes.error,WindowsError) as e:
			print '\n'+str(e)
		...
		try:
			...
			progress['value']=90
			tk.update_idletasks()
			lbl = Label(tk, text="90%", bg='grey', fg='purple')
			lbl.place(x=420,y=211,width=30,height=20)
			time.sleep(1)
		except (IOError,pywintypes.error,WindowsError) as e:
		...
		try:
			...
			progress['value']=100
			tk.update_idletasks()
			lbl = Label(tk, text="95%", bg='grey', fg='purple')
			lbl.place(x=420,y=211,width=30,height=20)
			time.sleep(1)
		except (IOError,pywintypes.error,WindowsError) as e:
		...
		progress['value']=120
		tk.update_idletasks()
		lbl = Label(tk, text="100%", bg='grey', fg='purple')
		lbl.place(x=420,y=211,width=30,height=20)
		time.sleep(10)
